...
/**
 * FactualOutro component displays a closing message and illustrations 
 * when the categorization of the data is factual.
 *
 * The component renders a series of SVG elements showcasing two characters, 
 * along with a personalized farewell message retrieved from the API response.
 *
 * @returns {JSX.Element} The rendered FactualOutro component.
 */
